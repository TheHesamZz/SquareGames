...
local details = {
    ["warning"] = {"Ekhtar", "warning", "w.mp3"},
    ["error"] = {"Error", "error", "error.wav"},
    ["info"] = {"Information", "information", "i.mp3"},
    ["jail"] = {"Jail News", "jail", "i.mp3"},
    ["admin"] = {"Admin System", "adminduty", "i.mp3"},
    ["success"] = {"Anjam Shod", "success", "s.mp3"},
    ["duty"] = {"Duty System", "duty", "s.mp3"},
	["news"] = {"Server News", "adminduty-off", "s.mp3"},
}
...
function getColors(render)
    ...
    if enabled then
        ...
        types = {
            ...
            ["mod"] = {"", {engine:getServerColor('red', false)}},
            ["models"] = {"", {engine:getServerColor('orange', false)}},
            ["success"] = {"", {engine:getServerColor('green', false)}},
            ["admin"] = {"", {engine:getServerColor('lightyellow', false)}},
			["duty"] = {"", {engine:getServerColor('gray', false)}},
			["news"] = {"", {engine:getServerColor('red', false)}},
        }
    end
end
